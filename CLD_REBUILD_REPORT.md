> Historical upstream report, imported from Prasad revision d745360d (2026-09-04). Its participant counts, findings and verification claims describe that source deployment, not a new computation or validation against Aditya's canonical data. Current Aditya research-only boundaries remain in force.
