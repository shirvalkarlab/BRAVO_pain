...
const CalculateSpectralPeaksEditor = ({currentState, newProcess, availableRecordings, defaultConfigs, updateConfiguration}) => {
    ...
    <MDBox style={{marginTop: 20, paddingTop: 5, paddingBottom: 15}}>
      <Autocomplete 
        ...
        onChange={(event, newValue) => setFilterOptions((filterOptions) => {
          ...
          filterOptions.output = newValue + "_SpectralPeaks";
...
export default CalculateSpectralPeaksEditor;