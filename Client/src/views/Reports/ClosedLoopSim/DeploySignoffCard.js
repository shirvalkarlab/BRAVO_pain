    ...
    <Card className="cl-signoff-card"
      ...
      <MDBox p={2.5}>
        <MDBox display="flex" justifyContent="space-between" alignItems="center" mb={1}>
          <MDTypography variant="h5" sx={{ fontSize: 18 }}>Closed-loop research review</MDTypography>
          {data ? (
