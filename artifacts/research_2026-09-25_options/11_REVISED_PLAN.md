...
**Visit structure (the PI, 2026-09-26: "max visit is 2 hrs").** Lane C above and answer 8 describe a single 334-minute visit; they are superseded by the protocol (`artifacts/protocol_2026-09-25_rate_swap_and_down_first_ladder.md`, revised 2026-09-26): Visit 1 is the rate swap and the down-first ladder (left 3.5 -> 2.5 -> 1.5 -> 0.5 -> 1.5 -> 2.5 -> 3.5 mA, 1 mA steps; two-way pairs at 1.5 and 2.5 mA), 98 minutes door to door (120 with the conditional second cycle); the home sequence (3 -> 4 -> 3 -> 2 -> 3 mA, ethics confirmed) follows at home; the stimulation-off block cannot keep its 90-minute wait inside 2 hours, and its four options (shorter in-clinic block, clinic-then-home, a shorter wait, or dropped) wait on the PI. Also answered 2026-09-26: 60 Hz first exposure covered; REDCap filed at each off-block rating.
