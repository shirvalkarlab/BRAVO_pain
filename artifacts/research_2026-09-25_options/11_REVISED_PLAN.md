...
**Visit structure (the PI, 2026-09-26: "max visit is 2 hrs").** Lane C above and answer 8 describe a single 334-minute visit; they are superseded by the protocol (`artifacts/protocol_2026-09-25_rate_swap_and_down_first_ladder.md`, revised twice on 2026-09-26): Visit 1 is the rate swap and the down-first ladder (left 3.5 -> 2.5 -> 1.5 -> 0.5 -> 1.5 -> 2.5 -> 3.5 mA, 1 mA steps; two-way pairs at 1.5 and 2.5 mA), 98 minutes door to door (120 with the conditional second cycle); the home sequence (3 -> 4 -> 3 -> 2 -> 3 mA, ethics confirmed) follows at home; the stimulation-off block could not keep its 90-minute wait inside 2 hours, and the PI chose option (c), a shorter wait inside one 2-hour visit ("stim off -c yes"): Visit 2, at the home sequence's follow-up, is 120 minutes door to door with 70 minutes at 0 mA, a 30-minute wait and a rating (the sheet's 0-10 scores, then the REDCap survey) every 4 minutes after it, each followed by a 2-minute recording: 10 ratings after the wait (minutes 30-66) and 2 labelled, uncounted ones inside it (minutes 6 and 18). The record does not support a wait shorter than 90 minutes (nothing measured covers minutes 15-90 after a switch-off), so Visit 2 describes the first hour off and a flat result cannot be told apart from relief that has not worn off; the PI chose it knowing that. Options (a) the 90-minute wait kept in a 70-minute block, (b) off continued at home, and (d) no off block are kept in the protocol as considered and not chosen. Also answered 2026-09-26: 60 Hz first exposure covered; REDCap filed at each off-block rating; the 2 mA home hold's condition, "1.5 and 2.5 mA both tolerated on both legs of the Visit 1 ladder", accepted. Every question for the PI is answered; the open items are for Medtronic or the clinical team (protocol §11).
