...
| N-15 | MEGA 08-30 (housekeeping) | ~~Delete the loose copies of device session files in the bridge folder.~~ Done by the PI, 2026-09-25: `_ingest_incoming`, `incoming_aug` and the loose files at the top of `incoming/` moved to the Trash (9.0 GB). `incoming/RCS08` stays: it is the daily ingest's live staging folder. | Closed. |
...
| N-19 | HANDOFF 06-21 (TODO 4, §7-D) | ~~Re-run the CodeRabbit review.~~ Dropped by the PI, 2026-09-25. | Closed. |
