...
- container, Biomarkers plus CacheStore plus DecodeCommon: **PASS=537 FAIL=0** (2026-09-07, after Track C step 4)
- host, ClosedLoopDeployment plus StimOptimizer plus CacheStore plus DecodeCommon: **934 passed,
  41 skipped**, in both orders (2026-09-07, after Track C step 4)
