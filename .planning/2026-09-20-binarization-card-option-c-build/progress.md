...
- Later the same day: the three settings renamed (Report-first matching / Neural-first matching / Neural-first, pre-report) and the histogram stacked (04b555a7); the per-report reader deleted, both copies and 26 tests, host 1419 / 2 / 0, container 674 / 0 (d5c9f5fe, decision 225); the Compute response's timeline copy removed, 212,752 fields, 0 differing on what stays, timeline endpoint 0 differing (98e43b0f, decision 226). Plan closed.
