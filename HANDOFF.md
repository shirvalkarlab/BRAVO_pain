...
> `main.a9b84eaa.js`. Migrations through `0009_sourcefile_device_institute`.
...
- **Branch/commit:** `PS_biomarker_module` (latest = the biomarker-UI-enhancement commit below; the prior
  ...
  PS_biomarker_module` when ready). Latest biomarker bundle `Client/build/static/js/main.a9b84eaa.js`
...
**Biomarker rigor + ROC/bar-plot follow-up (DONE — bundle `main.a9b84eaa.js`):** acted on the user's
