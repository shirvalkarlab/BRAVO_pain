...
# --------------------------------------------------------------------------------------------
# the acceptance case from the synthesis itself, built from constructed data matching its own
# reported statistics rather than the live record (the live record is proven separately, on
# RCS08, through the bridge -- see the decision log)
# --------------------------------------------------------------------------------------------
