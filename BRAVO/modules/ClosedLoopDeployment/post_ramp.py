...
SETTLED OFF: BY MEASUREMENT (decision 196) AND BY THE PI'S RULING OF 2026-09-20 (decision 217:
"make sure the margin switch is off; we want to use as much data as we can") -- the titration session
of 2026-09-16 was run, and the switch stays OFF regardless.

EARLIER: SETTLED OFF BY MEASUREMENT, 2026-09-17 (decision 196, the PI: "settle the issue for S7, remove
