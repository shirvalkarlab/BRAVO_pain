...
1. **The device's own reading counts as ground truth only after a per-channel saturation ceiling
   ...
   (a precomputed table in `ceiling_thresholds.py`, the 99.5th percentile of this participant's
   full recorded history per electrode and band centre, decision 52).* About 1 percent of simultaneous windows are device-side spikes where the reading jumps
